...
function ProjectItem({ name, githubLink, description, technologies }) {
  return (
    <div className="bg-white p-4 rounded-md mb-4">
      <h3 className="text-xl font-bold mb-2">{name}</h3>
      <article className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
        <p className="font-bold mb-2 md:mb-0">GitHub:</p>
        <a
          href={githubLink}
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500 hover:underline md:max-w-xs truncate md:ml-2"
        >
          {githubLink}
        </a>
      </article>
